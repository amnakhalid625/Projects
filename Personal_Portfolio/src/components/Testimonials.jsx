                ...
                >
                    {testimonials.map((item) => {
                        return <SwiperSlide key={item.id}>
                            <div className='border border-gray-400 shadow-md shadow-yellow-500 rounded-lg flex flex-col p-4'>
                                {item.rating === 4 ? (
                                    <div className='flex'>
                                        <Star fill='true' />
                                        <Star fill='true' />
                                ...
                                <div className='flex justify-between items-center'>
                                    <div>
                                        <h3 className='font-semibold text-yellow-500 text-lg'>{item.name}</h3>
